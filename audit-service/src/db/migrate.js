...
const runMigrations = async () => {
  ...
  try {
    ...
    // ─── Audit Trail Snapshots (Point-in-time entity states) ────────────────
    await pool.query(`
    ...
    // ─── Audit Chain Validation Table (Blockchain-style integrity) ──────────
    await pool.query(`
    ...
    // ─── Audit Queries (Frequently accessed audit trails) ───────────────────
    await pool.query(`
